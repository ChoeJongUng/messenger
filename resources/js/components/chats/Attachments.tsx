  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-14 items-center gap-2 border-b border-secondary bg-background px-2 lg:shadow-sm">
        ...
        <h5 className="font-medium">미디어, 파일 및 링크</h5>
      </div>
        ...
        <Tab.Panels className="h-[calc(100vh_-_120px)]">
          <Tab.Panel className="flex h-full flex-col">
            {media.length > 0 ? (
              ...
              <div className="my-auto text-center">미디어 비였음</div>
            )}
          </Tab.Panel>
          <Tab.Panel className="flex h-full flex-col">
            {files.length > 0 ? (
              ...
              <div className="my-auto text-center">파일 비였음</div>
            )}
          </Tab.Panel>
          <Tab.Panel className="flex h-full flex-col">
            {links.length > 0 ? (
              ...
              <div className="my-auto text-center">링크 비였음</div>
            )}
          </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
